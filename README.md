# AutocadQRCoder
All the magic of AutocadQRCoder comes the basic usage of [QRCoder library](https://github.com/codebude/QRCoder) to enable the creation of AutoCAD entities (block or hatch) figuring QR Codes.
### Usage
